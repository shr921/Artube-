...
const iconPaths: { [key: string]: string } = {
  ...
  shorts: 'M13 10V3L4 14h7v7l9-11h-7z',
  ...
  dislike: 'M10 15v4a3 3 0 003 3l4-9V2H5.72a2 2 0 00-2 1.7l-1.38 9a2 2 0 002 2.3zM17 2H4a2 2 0 01-2 2v7a2 2 0 012 2h3',
  ...
  'visa': 'M3.75 6.25h2.5l1.5 8h-2.5l-1.5-8zm6.5 8h2.5l1.5-8h-2.5l-1.5 8zm6.5-8h-2l-2.5 8h2l2.5-8zM21.25 6.25l-2.5 8h2.5l2.5-8h-2.5z', // Simplified representation
  'mastercard': 'M12 12a5 5 0 11-5-5 5 5 0 015 5zm5 0a5 5 0 11-5-5 5 5 0 015 5z', // Simplified representation
